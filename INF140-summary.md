<!-- TOC -->autoauto- [INF140 Summary](#inf140-summary)auto    - [Overview of Cybersecurity](#overview-of-cybersecurity)auto        - [What is cybersecurity](#what-is-cybersecurity)auto        - [Key questions in cybersecurity](#key-questions-in-cybersecurity)auto        - [CIA Triad](#cia-triad)auto        - [Pakerian hexad](#pakerian-hexad)auto        - [Security attributes](#security-attributes)auto        - [What can adversaries do](#what-can-adversaries-do)auto        - [Security vs privacy](#security-vs-privacy)auto        - [Vulnerabilities](#vulnerabilities)auto        - [Security threats](#security-threats)auto        - [Security risks (vulnerabilities x threats x impacts)](#security-risks-vulnerabilities-x-threats-x-impacts)auto        - [Security controls(countermeasures, safeguard)](#security-controlscountermeasures-safeguard)auto        - [Multi-layered defense](#multi-layered-defense)auto        - [Security control protections](#security-control-protections)auto        - [Risks](#risks)auto            - [Risk management](#risk-management)auto            - [Risk assessment](#risk-assessment)auto            - [Quantitative and qualitative analysis](#quantitative-and-qualitative-analysis)auto        - [Threat models](#threat-models)auto    - [Identification and Authentication](#identification-and-authentication)auto        - [Identification](#identification)auto        - [Requirements on Identification](#requirements-on-identification)auto        - [Authentication](#authentication)auto            - [User Authentication](#user-authentication)auto            - [Means of Authentication](#means-of-authentication)auto            - [Password Bases Authentication](#password-bases-authentication)auto                - [Storing Passwords in Clear Text](#storing-passwords-in-clear-text)auto                - [Storing Passwords as Encrypted text](#storing-passwords-as-encrypted-text)auto                - [Storing Passwords as Hashed Text](#storing-passwords-as-hashed-text)auto                - [Cracking passwords](#cracking-passwords)auto                - [Salting Passwords](#salting-passwords)auto                - [Password Storage Best Practice](#password-storage-best-practice)auto                - [Passwords Vulnerabilities and Countermeasures](#passwords-vulnerabilities-and-countermeasures)auto                - [Other Common Characteristics of Passwords](#other-common-characteristics-of-passwords)auto                - [Password Selection Strategies](#password-selection-strategies)auto                - [Passwords:  Do’s and Don't s](#passwords--dos-and-dont-s)auto            - [Token-Bases Authentication](#token-bases-authentication)auto                - [Memory Cards](#memory-cards)auto                - [Smart Cards](#smart-cards)auto            - [Bio-metric Authentication](#bio-metric-authentication)auto    - [Malicious Software](#malicious-software)auto        - [Malware (Malicious software/code)](#malware-malicious-softwarecode)auto            - [Classification of malware](#classification-of-malware)auto        - [Viruses](#viruses)auto            - [Compression Virus](#compression-virus)auto            - [Types of Viruses By target](#types-of-viruses-by-target)auto            - [Propagation of viruses](#propagation-of-viruses)auto            - [Types of Viruses by Concealment Strategy](#types-of-viruses-by-concealment-strategy)auto        - [Worms](#worms)auto            - [Worm Replication](#worm-replication)auto        - [Trojan Horses](#trojan-horses)auto        - [Types of Malware Damage](#types-of-malware-damage)auto            - [Zombies and Bots](#zombies-and-bots)auto                - [Use of Botnets](#use-of-botnets)auto            - [Information Theft](#information-theft)auto            - [Phishing](#phishing)auto            - [Other Malware](#other-malware)auto        - [Comparison of Malware](#comparison-of-malware)auto        - [Malware Countermeasure Approaches](#malware-countermeasure-approaches)auto            - [Development of Anti-virus Software](#development-of-anti-virus-software)auto            - [Generic Decryption](#generic-decryption)auto            - [Host-Based Behavior](#host-based-behavior)auto        - [Malware Security Issues](#malware-security-issues)auto    - [Firewalls](#firewalls)auto        - [Why firewalls](#why-firewalls)auto        - [Firewall characteristics](#firewall-characteristics)auto        - [Firewall capabilities](#firewall-capabilities)auto        - [Firewall limitations](#firewall-limitations)auto        - [Types of firewalls](#types-of-firewalls)auto            - [Packet Filtering Firewall](#packet-filtering-firewall)auto                - [Packet filtering rules](#packet-filtering-rules)auto            - [iptables](#iptables)auto            - [iptables concepts](#iptables-concepts)auto            - [iptables Chains](#iptables-chains)auto            - [iptables rules](#iptables-rules)auto            - [Common iptables Syntax](#common-iptables-syntax)auto            - [Issues with Packet Filtering Firewalls](#issues-with-packet-filtering-firewalls)auto        - [Stateful Packet Inspection](#stateful-packet-inspection)auto        - [Application proxy](#application-proxy)auto        - [Circuit-level proxy](#circuit-level-proxy)auto        - [Firewall Architecture](#firewall-architecture)auto        - [General Firewall Issues](#general-firewall-issues)auto    - [Authentication in Networks](#authentication-in-networks)auto        - [Overview of authentication](#overview-of-authentication)auto        - [Authentication in WPA2](#authentication-in-wpa2)auto        - [Entity authentication in networks](#entity-authentication-in-networks)auto        - [Types of authentication protocols](#types-of-authentication-protocols)auto            - [Secret info-based authentication](#secret-info-based-authentication)auto                - [AAA architecture protocols](#aaa-architecture-protocols)auto                - [892.1X(EAPOL)](#8921xeapol)auto                - [Extensible Authentication Protocol(EAP)](#extensible-authentication-protocoleap)auto                - [RADIUS](#radius)auto        - [Virtual Private Network (VPN)](#virtual-private-network-vpn)auto        - [Tunneling](#tunneling)auto        - [Network access server(NAS)](#network-access-servernas)auto        - [Network Access Enforcement Methods](#network-access-enforcement-methods)auto    - [Public Key Certificates](#public-key-certificates)auto        - [Distribution of Public Keys](#distribution-of-public-keys)auto            - [Public announcements](#public-announcements)auto            - [Publicly Available Directory](#publicly-available-directory)auto            - [Public-Key Authority](#public-key-authority)auto            - [Public-Key Certificates](#public-key-certificates)auto        - [X.509 Certificates](#x509-certificates)auto            - [Multiple Certificate Authorities](#multiple-certificate-authorities)auto        - [Public Key Infrastructure](#public-key-infrastructure)auto        - [PGP - Web of Trust](#pgp---web-of-trust)autoauto<!-- /TOC -->
